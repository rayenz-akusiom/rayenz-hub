import { shouldShowLink } from './settings';
import type { DailiesSettingsPayload } from '@rayenz-hub/shared';

const IMG = 'https://images.neopets.com/items/';

export const ALBUM_LINK_IDS = ['gourmet-club', 'stamp-album', 'books-read', 'booktastic-read'];
...
export const BOOK_SHOPS: BookShop[] = [
  {
    id: 'magical-bookshop',
...
export type DailyLink = {
  ...
  kind?: string;
  note?: string;
  faerieQuest?: 'illusen' | 'jhudora';
  school?: string;
};

export const DAILIES_LINKS: DailyLink[] = [
  {
    id: 'main-pet',
    label: 'Main Pet',
    group: 1,
    petLink: true,
    petHref: 'https://www.neopets.com/island/fight_training.phtml?type=status',
    img: null,
    kind: 'pet',
  },
  {
    ...
    img: 'https://images.neopets.com/shopkeepers/shopwizard.gif',
  },
  {
    id: 'safety-deposit',
  ...
  },
  {
    ...
    label: 'Gallery',
    group: 1,
    url: 'https://www.neopets.com/gallery/index.phtml',
    img: 'https://images.neopets.com/new_shopkeepers/1107.gif',
  },
  {
    id: 'premium',
    label: 'Premium',
    group: 1,
    url: 'https://www.neopets.com/premium/',
    img: IMG + 'mall_spacefaeriedoll.gif',
  },

  {
    ...
    group: 2,
    petLink: true,
    petHref: 'https://www.neopets.com/gourmet_club.phtml?pet_name={pet}',
    img: 'https://images.neopets.com/games/trophies/trophy_gourmet_1.gif',
  },
  {
    id: 'stamp-album',
    label: 'Stamp Album',
    group: 2,
    url: 'https://www.neopets.com/stamps.phtml?type=progress',
    img: IMG + 'book_stamps.gif',
  },
  {
    id: 'books-read',
    label: 'Books',
    group: 2,
    petLink: true,
    petHref: 'https://www.neopets.com/books_read.phtml?pet_name={pet}',
    img: 'https://images.neopets.com/games/trophies/trophy_books_read_1.gif',
  },
  {
    id: 'booktastic-read',
    label: 'Booktastic Books',
    group: 2,
    petLink: true,
    petHref: 'https://www.neopets.com/moon/books_read.phtml?pet_name={pet}',
    img: 'https://images.neopets.com/games/trophies/trophy_booktastic_books_1.gif',
  },
  ...
  },
  {
    ...
    img: IMG + 'gar_pirate_bouncyship.gif',
  },
  {
    id: 'deserted-tomb',
    label: 'Deserted Tomb',
    ...
    img: IMG + 'bd_ger_goldtalisman.gif',
  },
  {
    id: 'forgotten-shore',
    ...
    img: IMG + 'toy_chest_discoveredtreasure.gif',
  },
  {
    id: 'fruit-machine',
    label: 'Fruit Machine',
  ...
  },
  {
    ...
    img: IMG + 'om_sausage_pepperoni1.gif',
  },
  {
    id: 'lair-of-the-beast',
    label: 'Lair of the Beast',
    group: 3,
    url: 'https://www.neopets.com/prehistoric/thebeast.phtml',
    img: IMG + 'bd_tyrannia_beastclaw.gif',
  },
  {
    id: 'meteor',
    label: 'Meteor',
    ...
    img: IMG + 'bd_meteor_rock.gif',
    note: 'Once every hour',
  },
  {
    id: 'negg-cave',
    label: 'Mysterious Negg Cave',
    group: 3,
    url: 'https://www.neopets.com/shenkuu/neggcave/',
    img: IMG + 'plu_fony14_neggbreaker.gif',
  },
  {
    id: 'wheel-extravagance',
    label: 'Wheel of Extravagance',
    group: 3,
    url: 'https://www.neopets.com/desert/extravagance.phtml',
    img: IMG + 'sta_wheel_of_extravagance.gif',
    note: 'Twice a day',
  },
  {
    id: 'tdmbgpop',
    label: 'Discarded Magical Blue Grundo Plushie',
    group: 3,
    url: 'https://www.neopets.com/faerieland/tdmbgpop.phtml',
    img: IMG + 'plu_TDMBGPOP_replica.gif',
  },
  {
    id: 'tombola',
    label: 'Tombola',
    ...
    img: IMG + 'toy_squeezy_tombola.gif',
  },
  {
    id: 'trudys',
    ...
    img: IMG + 'gif_trudy_coin_purse.gif',
  },
  {
    id: 'wise-king',
    label: 'Wise Old King',
  ...
  },
  {
    ...
    img: 'https://images.neopets.com/medieval/grumpy_king_notamused.gif',
  },
  {
    id: 'faerie-caverns',
    label: 'Faerie Caverns',
    group: 3,
    url: 'https://www.neopets.com/faerieland/caverns/index.phtml',
    img: IMG + 'bg_faerie_caverns.gif',
  },
  {
    id: 'wheel-starlight',
...

  {
    ...
    img: 'https://images.neopets.com/themes/h5/constellations/images/games-icon.svg?d=20210209',
  },
  {
    id: 'customization',
    label: 'Customization',
    ...
    img: 'https://images.neopets.com/themes/h5/constellations/images/customise-icon.svg',
  },

  {
    ...
    img: IMG + 'toy_faerie_water.gif',
    note: 'Every 30 min',
    school: 'healing-springs',
  },
  {
    id: 'battledome',
    label: 'Battledome',
  ...
  },
  {
    ...
    img: IMG + 'toy_faerie_princess.gif',
    note: 'Cookie=Once/day',
    school: 'faerie-quests',
  },
  {
    id: 'swashbuckling',
    label: 'Swashbuckling Academy',
    group: 5,
    url: 'https://www.neopets.com/pirates/academy.phtml?type=status',
    img: IMG + 'toy_pirate_cutlass.gif',
    school: 'swashbuckling',
  },
  {
    id: 'mystery-island',
    label: 'Mystery Island Training',
    group: 5,
    url: 'https://www.neopets.com/island/training.phtml?type=status',
    img: IMG + 'bg_mystery_training.gif',
    school: 'mystery-island',
  },
  {
    id: 'secret-ninja',
    label: 'Secret Ninja Training',
    group: 5,
    url: 'https://www.neopets.com/island/fight_training.phtml?type=status',
    img: IMG + 'nin_smoke_bomb.gif',
    school: 'secret-ninja',
  },
  {
    id: 'lab-ray',
    ...
    img: IMG + 'labmap_09.gif',
    note: 'Once a day',
    school: 'lab-ray',
  },
  {
    id: 'kitchen-quests',
    label: 'Kitchen Quests',
    group: 5,
    url: 'https://www.neopets.com/island/kitchen.phtml',
    img: IMG + 'toy_kitchenquest_flotsam.gif',
    note: '10 times a day',
    school: 'kitchen-quests',
  },

  {
    id: 'fishing',
    label: 'Ye Olde Fishing Vortex',
    group: 6,
    url: 'https://www.neopets.com/water/fishing.phtml',
    img: IMG + 'vor_evilcarp.gif',
    note: 'Random',
  },
  {
    id: 'coltzan',
    ...
    img: IMG + 'bd_desert_deathmask.gif',
    note: 'Every 13 hours',
  },
  {
    id: 'grave-danger',
    ...
    img: IMG + 'boo_zombiehandbook.gif',
    note: 'Up to 10 hours',
  },
  {
    id: 'ice-kiosk',
    label: 'Ice Caves Kiosk',
    group: 6,
    url: 'https://www.neopets.com/winter/kiosk.phtml',
    img: IMG + 'toy_kiosk_plushie.gif',
    note: 'Every 6 hours',
  },
  {
    id: 'wheel-excitement',
    ...
    img: IMG + 'sta_stw_wheelofexcitement.gif',
    note: 'Every 2 hours',
  },
  {
    id: 'wheel-knowledge',
    ...
    img: IMG + 'bvb_wheelofknowledge.gif',
    note: 'Every 2 hours',
  },
  {
    id: 'test-strength',
    ...
    img: IMG + 'gar_testyourstrength.gif',
  },
  {
    id: 'wheel-monotony',
    ...
    img: IMG + 'toy_miniwheelofmonotony.gif',
  },

  {
    id: 'shop-till',
    label: 'Your Shop Till',
    group: 8,
    url: 'https://www.neopets.com/market.phtml?type=till',
    img: IMG + 'broken_bag_np.gif',
  },
  {
    id: 'bank',
    label: 'Bank Interest',
  ...
  },
  {
    ...
    img: 'https://images.neopets.com/games/game_stocks.gif',
  },
  {
    id: 'food-club',
    label: 'Food Club',
    ...
    img: 'https://images.neopets.com/games/pages/trophies/88_1.png',
  },
];

export function getFilteredLinks(settings: DailiesSettingsPayload | Record<string, never>): DailyLink[] {
  return DAILIES_LINKS.filter((link) => shouldShowLink(link, settings));
}

export function getLinksByGroup(
  settings: DailiesSettingsPayload | Record<string, never>,
): Record<number, DailyLink[]> {
  const links = getFilteredLinks(settings);
  const groups: Record<number, DailyLink[]> = {};
  for (const link of links) {
    const g = link.group || 0;
    if (!groups[g]) {
      groups[g] = [];
    }
    groups[g].push(link);
